/*
 * This is an early implementation of cp from https://www.tuhs.org/cgi-bin/utree.pl?file=V5/usr/source/s1/cp.c
 * It works nearly as-is, the only change that pointer declarations had to be changed to array declarations.
 *
 * Usage:
 * cp oldfile newfile
 */
